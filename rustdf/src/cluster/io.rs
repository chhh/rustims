...
pub fn save_parquet(path: &str, clusters: &[ClusterResult1D]) -> io::Result<()> {
    ...
    let mut df = DataFrame::new(vec![
        Series::new(PlSmallStr::from("cluster_id"), cluster_id).into(),
        Series::new(PlSmallStr::from("ms_level"), ms_level).into(),
        Series::new(PlSmallStr::from("window_group"), window_group).into(),
        Series::new(PlSmallStr::from("parent_im_id"), parent_im_id).into(),
        Series::new(PlSmallStr::from("parent_rt_id"), parent_rt_id).into(),

        Series::new(PlSmallStr::from("rt_lo"), rt_lo).into(),
        Series::new(PlSmallStr::from("rt_hi"), rt_hi).into(),
        Series::new(PlSmallStr::from("im_lo"), im_lo).into(),
        Series::new(PlSmallStr::from("im_hi"), im_hi).into(),
        Series::new(PlSmallStr::from("tof_lo"), tof_lo).into(),
        Series::new(PlSmallStr::from("tof_hi"), tof_hi).into(),
        Series::new(PlSmallStr::from("tof_index_lo"), tof_index_lo).into(),
        Series::new(PlSmallStr::from("tof_index_hi"), tof_index_hi).into(),
        Series::new(PlSmallStr::from("mz_lo"), mz_lo).into(),
        Series::new(PlSmallStr::from("mz_hi"), mz_hi).into(),

        Series::new(PlSmallStr::from("rt_mu"), rt_mu).into(),
        Series::new(PlSmallStr::from("rt_sigma"), rt_sigma).into(),
        Series::new(PlSmallStr::from("rt_height"), rt_height).into(),
        Series::new(PlSmallStr::from("rt_area"), rt_area).into(),

        Series::new(PlSmallStr::from("im_mu"), im_mu).into(),
        Series::new(PlSmallStr::from("im_sigma"), im_sigma).into(),
        Series::new(PlSmallStr::from("im_height"), im_height).into(),
        Series::new(PlSmallStr::from("im_area"), im_area).into(),

        Series::new(PlSmallStr::from("tof_mu"), tof_mu).into(),
        Series::new(PlSmallStr::from("tof_sigma"), tof_sigma).into(),
        Series::new(PlSmallStr::from("tof_height"), tof_height).into(),
        Series::new(PlSmallStr::from("tof_area"), tof_area).into(),

        Series::new(PlSmallStr::from("mz_mu"), mz_mu).into(),
        Series::new(PlSmallStr::from("mz_sigma"), mz_sigma).into(),
        Series::new(PlSmallStr::from("mz_height"), mz_height).into(),
        Series::new(PlSmallStr::from("mz_area"), mz_area).into(),

        Series::new(PlSmallStr::from("raw_sum"), raw_sum).into(),
        Series::new(PlSmallStr::from("volume_proxy"), volume_proxy).into(),
